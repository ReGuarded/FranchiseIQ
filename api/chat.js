  ...
  try {
    ...
    if (type === 'research') {
      ...
      var searches = [
        ...
        { key: 'apartments',  query: 'apartment complex',                      radius: 3200, maxN: 8, presort: true  },
        { key: 'hotels',      query: 'hotel motel inn suites',                 radius: 3200, maxN: 6, presort: false },
        { key: 'gyms',        query: 'gym fitness center boxing martial arts', radius: 3200, maxN: 6, presort: false },
        { key: 'medical',     query: 'medical clinic dental urgent care',      radius: 3200, maxN: 6, presort: false },
        { key: 'restaurants', query: 'restaurant cafe food service',           radius: 3200, maxN: 6, presort: false },
        { key: 'salons',      query: 'hair salon nail spa beauty',             radius: 3200, maxN: 6, presort: false },
        { key: 'automotive',  query: 'auto repair mechanic shop',              radius: 3200, maxN: 6, presort: false }
      ];
